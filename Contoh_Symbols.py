...
terminals3 = ["defmodule","atom_name","do","def", "funct_name", "(", ")", "param_name", ",", "var_name", "=", "[", "]", "number", "end", ".", "|", "_", "+", "-"]

symbols3 = [
  "defmodule", "atom_name", "do", 
    "def", "funct_name", "(","param_name", ")", "do", 
      "var_name", "=", "[","number", ",", "number", "]", 
      "funct_name", "(", "var_name", ",", "var_name", ")",
    "end",
    "def", "funct_name", "(", "param_name", ",", "number", ")", "do",
      "atom_name", ".", "funct_name", "(","var_name", ")",
    "end",
    ...
    "end",
  "end",
  "atom_name",".","funct_name", "(", "funct_name", "(", "atom_name", ".", "funct_name", "(", "number", ")", ")", ")", "EOF"]
...
terminals2 = ["defmodule","atom_name","do","def", "funct_name", "(", ")", "parameter", ",", "when","and", "<", "/", "!=", "==", "literal",'"', "#", "{", "}", "var_name", "=", "[", "]", "number", "end", ".", "|", "_", "+", "-"]
  ...
  "defmodule", "atom_name", "do", 
    "def", "funct_name", "(","param_name", ",", "param_name", ")", 
      ...
      "and", "funct_name","(","var_name", ",", "var_name", ")", "!=", "number", "do", 
        "atom_name", ".", "funct_name", "(",'"',"#","{", "var_name" ,"}", "literal", "literal", "literal", '"', ")" ,
        "end",
    "def", "funct_name", "(","param_name", ",", "param_name", ")", 
      "when", "var_name", "<","var_name","/", "number", 
      "and", "funct_name","(","var_name", ",", "var_name", ")", "==", "number", "do", 
        "atom_name", ".", "funct_name", "(",'"',"#","{", "var_name" ,"}", "literal", "literal", "literal", "literal", '"', ")" ,
        "end",
    "def", "funct_name", "(","param_name", ")", "do",
      "var_name", "=", "number",
    ...
    "end",
  "end", 
  "atom_name", ".", "funct_name", "(", "number", ")", "EOF"]
...
terminals1 = ["defmodule","atom_name","do","def","funct_name",".","(",r'"',r"'", ")", "end", "literal"]

symbols1 = ["defmodule","atom_name","do","def","funct_name","do", "atom_name",".","funct_name","(",'"',"literal","literal",'"',")","end","end", "atom_name", ".", "funct_name", "(", ")", "EOF"]
